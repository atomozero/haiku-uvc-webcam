...
| RF-02 | Dead deframer subclasses out of the build | Makefile, CamBufferingDeframer.*, CamStreamingDeframer.* | todo |
| RF-03 | printf toward syslog with throttle | addons/uvc/UVCCamDevice.cpp | todo |
