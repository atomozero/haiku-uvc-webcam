...
| FIX-46 | Per-packet atomics in pump, batch per transfer | CamDevice.cpp | Medium | todo |
| FIX-47 | YUY2 row check hoist and 32-bit pad fill | addons/uvc/UVCCamDevice.cpp, UVCDeframer.cpp | Low | todo |
